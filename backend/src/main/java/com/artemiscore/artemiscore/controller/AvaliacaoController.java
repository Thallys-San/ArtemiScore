...
public class AvaliacaoController {
    ...
    @PostMapping
    public ResponseEntity<String> avaliar(@Valid @RequestBody AvaliacaoModel avaliacaoModel) {
        Double nota = avaliacaoModel.getNota();
        return ResponseEntity.ok("Nota recebida: " + nota);
    }
